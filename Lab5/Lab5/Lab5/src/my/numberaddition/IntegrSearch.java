        ...
        if(!jTable.getSelectionModel().isSelectionEmpty() && Compare(str1) && Compare(str2) && Compare(str3)){
            ...
            if(!jTextField1.getText().isEmpty() && !jTextField2.getText().isEmpty() && !jTextField3.getText().isEmpty()){
                ...
                try{
                    ...
                    int iteration = (int)( ((tabEnts.get(j).GetUpLim() - tabEnts.get(j).GetLowLim()) / tabEnts.get(j).GetStepInteg()) / 4.0);
                    
                    
                    MyThread thr1 = new MyThread(0, iteration, tabEnts.get(j).GetLowLim(),tabEnts.get(j).GetUpLim(), 
                            tabEnts.get(j).GetStepInteg(), x -> {return Math.tan(x);});
                    MyThread thr2 = new MyThread(iteration, iteration * 2, tabEnts.get(j).GetLowLim(),tabEnts.get(j).GetUpLim(), 
                            tabEnts.get(j).GetStepInteg(), x -> {return Math.tan(x);} );
                    MyThread thr3 = new MyThread( iteration * 2, iteration * 3, tabEnts.get(j).GetLowLim(),tabEnts.get(j).GetUpLim(), 
                            tabEnts.get(j).GetStepInteg(), x -> {return Math.tan(x);} );
                    MyThread thr4 = new MyThread( iteration * 3, iteration * 4, tabEnts.get(j).GetLowLim(),tabEnts.get(j).GetUpLim(), 
                            tabEnts.get(j).GetStepInteg(), x -> {return Math.tan(x);} );
                    ...
                    //JOptionPane.showMessageDialog(Frame," " + thr1.GetArea() + " + " + thr2.GetArea() + " + " + thr3.GetArea() + " + " + thr4.GetArea());
