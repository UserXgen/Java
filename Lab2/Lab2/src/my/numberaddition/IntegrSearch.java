...
public class IntegrSearch extends javax.swing.JFrame {
    ...
    private void jButtonСalculateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonСalculateActionPerformed
        ...
        if(!jTable.getSelectionModel().isSelectionEmpty()){
            ...
            if(stepInteg != 0){
                area = integralTrap(x -> {return Math.tan(x);});
                jTable.setValueAt(area, selectedRow, 3);
            }
            else
                jTable.setValueAt(0, selectedRow, 3);
    ...
    private void jButtonClearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonClearActionPerformed
        ...
        for(int i = 0; i < jTable.getRowCount(); i++){
            ...
            if(jTable.getValueAt(i,0) != null){
                ...
                tabEnts.get(j).SetLowLim((double)jTable.getValueAt(i,0));
                tabEnts.get(j).SetUpLim((double)jTable.getValueAt(i,1));
                tabEnts.get(j).SetStepInteg((double)jTable.getValueAt(i,2));
                tabEnts.get(j).SetResult((double)jTable.getValueAt(i,3));
                j++;
    ...
    public LinkedList<RecIntegral> tabEnts;
